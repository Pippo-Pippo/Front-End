...
//             div1.className = 'ml-5 text-2xl font-bold mb-2';
//             mainDiv.append(div1);
...
//             if (category == "EARTHQUAKE") {
//                 button.className = 'h-8 bg-yellow-600 item-center rounded-full text-xs ml-5 px-4 p-2 mb-2 text-white font-bold';
//             }
//             else {
...
//             copyButton.className = 'ml-2 p-1 rounded bg-gray-600 text-white text-sm pl-2 pr-2 pt-1 pb-1';
